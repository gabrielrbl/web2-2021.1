                    ...
                    <tbody class="bg-white">
                        @foreach ($categorias as $categoria)
                            <tr class="text-gray-700">
                                <td class="px-4 py-3 text-ms font-semibold border">{{ strtoupper($categoria->categoria) }}</td>
                                <td class="px-4 py-3 text-xs border">
                                    <div class="inline-flex rounded-md shadow-sm" role="group">
                                        ...
                                        <button type="button" onclick="deletar('{{ $categoria->idcategoria }}', '{{ strtoupper($categoria->categoria) }}')"
