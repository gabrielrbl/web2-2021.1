                ...
                <table class="w-full">
                    ...
                    <tbody class="bg-white">
                        <tr class="text-gray-700">
                            ...
                            <td class="px-4 py-3 text-ms font-semibold border">(77) 98123-4653</td>
                            <td class="px-4 py-3 text-sm border">Cliente PF / CPF: 000.000.000-00</td>
                        ...
                        <span class="px-2 py-1 font-semibold leading-tight text-red-700 bg-red-100 rounded-sm">
                            ...
                            <td class="px-4 py-3 text-xs border">
                                <div class="inline-flex rounded-md shadow-sm" role="group">
                                    ...
                                    <button type="button" onclick="deletar('1', 'GABRIEL LOBO')"
