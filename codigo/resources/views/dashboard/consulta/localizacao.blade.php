    ...
    <section class="bg-gray-100 py-8">
        ...
        <div class="container mx-auto px-2 pt-4 pb-12 text-gray-800">
            <div class="flex justify-end">
                <a href="{{ route('cadastro.localizacao') }}">
                    <button type="button"
                    ...
                    <tbody class="bg-white">
                        @foreach ($localizacoes as $localizacao)
                            <tr class="text-gray-700">
                                <td class="px-4 py-3 text-ms font-semibold border">{{ strtoupper($localizacao->departamento) }}</td>
                                <td class="px-4 py-3 text-xs border">
                                    <div class="inline-flex rounded-md shadow-sm" role="group">
                                        ...
                                        <button type="button" onclick="deletar('{{ $localizacao->idlocalizacao }}', '{{ strtoupper($localizacao->departamento) }}')"
