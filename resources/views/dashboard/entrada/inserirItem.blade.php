...
@section('content')
    <script>
        function refreshParent(idproduto) {
            window.close();
            window.opener.location.href = '{{ route('entrada.itensentrada', $entrada->identrada) }}' + '/' + idproduto;
        }
    </script>
                ...
                <table class="w-full">
                    <thead>
                        <tr
                            ...
                            <th class="px-4 py-3">ÚLTIMO PREÇO DE COMPRA</th>
                    ...
                    <tbody class="bg-white">
                        @foreach ($produtos as $produto)
                            <tr class="text-gray-700">
                                ...
                                <td class="px-4 py-3 text-ms font-semibold border">R$ {{ round($produto->valordecompra, 2) }}</td>
