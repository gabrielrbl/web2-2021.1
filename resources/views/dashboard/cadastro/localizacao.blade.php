        ...
        <section class="container py-3">
            <div class="row align-items-center d-flex">
                <div class="col-2 col-md-2 col-sm-2">
                    <a href="{{ route('consulta.localizacao') }}" class="btn btn-primary">VOLTAR</a>
                </div>
                ...
                <form method="GET" id="form">
                    <div class="row">
                        <div class="col-6 col-md-4 col-sm-12 mb-3">
                            ...
                            <input type="text" name="departamento" id="localizacao" oninput="validaInput(this, true)"
                                class="form-control" placeholder="DEPARTAMENTO" autocomplete="off" required>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            $("#form").on("submit", function() {
                ...
                window.location.href = '{{ route("consulta.localizacao") }}';
            });
        });
    </script>
@endpush('scripts')
